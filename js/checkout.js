...
//everything seems to work up to this point, it all seems to be undefined even when i click a button its probably due to the key_name but i couldnt figure it out                 
...
//an else statement that will add the new information based off the saved cookies and their keynames
else {
